...
public class dashboardMitraView extends cDashboardFrame{
  ...
  private cSidebarMenu menuInfoSaldo = new cSidebarMenu("Info Telur", 70+50);
  private cSidebarMenu menuRequestPulsa = new cSidebarMenu("Request Telur", 70+50+50);
  ...
  private cLabelInfo labelSisaSaldoBeranda = new cLabelInfo("Sisa Telur", 25, 20);
  private cBigFont valueSisaSaldoBeranda = new cBigFont("25", 25, 60);
  ...
  private cLabelInfo labelRequestPulsaBeranda = new cLabelInfo("Pesanan Telur Customer Saat Ini", 25, 280);
  private cBigFont valueRequestPulsaBeranda = new cBigFont("10", 25, 320);

  
  // components of InfoSaldo
  private cLabelInfo labelSisaSaldoInfoSaldo = new cLabelInfo("Sisa Telur", 25, 20);
  private cBigFont valueSisaSaldoInfoSaldo = new cBigFont("10", 25, 60);
  private cLabelInfo labelRequestSaldoInfoSaldo = new cLabelInfo("Data Pesanan", 25, 150);
  private DefaultTableModel dmRequestSaldo;
  private cTable tblDataRequestSaldo;
  private cScrollPane spDataRequestSaldo;
  private cLabelInfo labelDoRequestSaldoInfoSaldo = new cLabelInfo("Sisa Telur", 490, 20);
  private cErrorLabel errorDoRequestSaldoInfoSaldo = new cErrorLabel("tidak bisa melakukan pesanan jika telur masih diatas 100Kg", 490, 60, 400, false);
  private cBlueButton btnRequestSaldo = new cBlueButton("Pesan", 490, 90, 155);
  
  
  // components of RequestPulsa
  private cLabelInfo labelDataRequestPulsa = new cLabelInfo("Sisa Telur Anda", 25, 20);
  private DefaultTableModel dmRequestPulsa;
  private cTable tblDataRequestPulsa;
  private cScrollPane spDataRequestPulsa;
  private cBlueButton btnIsiPulsa = new cBlueButton("Pesan Telur", 25, 280, 155);
  

  // components of Transaksi Saya
  private cLabelInfo labelDataTransaksiSaya = new cLabelInfo("Data Transaksi Telur Anda", 25, 20);
  ...
  private void initsRequestPulsa()
  {
    ...
    menuTitle.setText("Pesanan Telur Customer");
    String[] dataUserHeader = {"Header 1", "Header 2", "Header 3"};
    String[][] dataUser = {
      {"Row1 Col1", "Row1 Col2", "Row1 Col3"},
      {"Row2 Col1", "Row2 Col2", "Row2 Col3"},
  ...
  private void initsTransaksiSaya()
  {
    ...
    menuTitle.setText("Transaksi Telur Anda");
    String[] dataUserHeader = {"Header 1", "Header 2", "Header 3"};
    String[][] dataUser = {
      {"Row1 Col1", "Row1 Col2", "Row1 Col3"},
      {"Row2 Col1", "Row2 Col2", "Row2 Col3"},
